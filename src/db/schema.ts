...
export const tabelaConvidado = pgTable("convidado", {
  ...
  atividadeId: integer("atividade_id").notNull().references(() => tabelaAtividade.id, { onDelete: "cascade" }),
});
...
export const tabelaAtividade = pgTable("atividade", {
  ...
  eventoId: integer("evento_id").notNull().references(() => tabelaEvento.id, { onDelete: "cascade" }),
...
export const tabelaParticipacoes = pgTable("participacao", {
  ...
  usuarioId: integer("usuario_id").notNull().references(() => tabelaUsuario.id, { onDelete: "cascade" }),
...
export const tabelaParticipacoesAtividades = pgTable("participacoes_atividades", {
  participacaoId: integer("participacao_id").notNull().references(() => tabelaParticipacoes.id, { onDelete: "cascade" }),
  atividadeId: integer("atividade_id").notNull().references(() => tabelaAtividade.id, { onDelete: "cascade" }),
});
...
export const tabelaAtividadeRelations = relations(tabelaAtividade, ({ many, one }) => ({
  //Uma atividade pertence a um evento
...
export const tabelaParticipanteRelations = relations(tabelaParticipacoes, ({ many, one }) => ({
  //Um participante é um usuário
...
export const tabelaParticipacaoAtividadeRelations = relations(tabelaParticipacoesAtividades, ({ one }) => ({
...
export const tabelaConvidadoRelations = relations(tabelaConvidado, ({ one }) => ({
...
export const tabelaCertificadoEventoRelations = relations(tabelaCertificadoEvento, ({ one }) => ({
...
export const tabelaCertificadoAtividadeRelations = relations(tabelaCertificadoAtividade, ({ one }) => ({
  //Um certificado pertence a um usuário
  usuario: one(tabelaUsuario, {
